...
export const PRICING_PLANS: PricingPlan[] = [
  {
    ...
    price: "$0",
    priceDetail: "/month",
    description: "Explore AI-generated inventory insights with a single CSV upload.",
    features: [
      "Up to 100 SKUs",
      "Manual CSV upload",
      "AI best & slow movers view",
      "Weekly refresh",
    ],
  ...
  },
  {
    ...
    price: "$57",
    priceDetail: "/month",
    description: "For growing teams that need AI-detected trends and opportunities.",
    features: [
      "Up to 10,000 SKUs",
      "AI trend & opportunity detection",
      "AI insight briefings",
      "Priority support",
    ],
  ...
  },
  {
    ...
    features: [
      "Unlimited SKUs",
      "Multi-brand & multi-region AI analysis",
      "Full report exports",
      "Dedicated support",
    ],
